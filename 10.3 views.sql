...
select * from Aplica;
insert into CSaccept values('2345','UnivTest');
...
/**************************************************************
  ...
  in Oracle e permis dar cu conditiile:
    este afectat doar unul dintre tabelele de baza
    celelalte tabele trebuie sa fie "key-preserved", adica fiecare dintre ele trebuie sa aiba o linie in tabelul de mai sus.
...
CREATE VIEW ops AS Select sid, snume, medie+1 as m, dimliceu from student;
select * from ops;
delete from ops where m=10.66;
insert into ops values (123, 'AAA', null, 1000);
